...
class ApiClient {
  ...
  // delivery
  static const String addDeliveryMan = '$baseUrl/api/users/add-delivery-man';
  static const String deliveryMenShop = '$baseUrl/api/delivery-men/shop/';
  static const String deliveryMenList = '$baseUrl/api/delivery-men/list';
